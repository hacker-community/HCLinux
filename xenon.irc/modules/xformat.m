...
set format_ctcp $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_cloak_func $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_cloak_func_user $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_cloak_unknown $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_cloak_unknown_user $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_cloak_user $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_func $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_func_user $G ฎ ${hblk}[${hcyn}c${cyn}tcp${prp}!${cyn}$1${prp}(${cyn}$2${prp})${hblk}]${hwht}: ${wht} $4-
set format_ctcp_reply $G ฎ ${hblk}[${hcyn}r${cyn}eply${prp}!${cyn}$1${prp}(${cyn}$2${prp})${cyn}$tolower($3)${hblk}]${hwht}:${wht} $4-
...
set format_join $G ${b}${prp}ฏ ${b}${hblk}[${hcyn}j${cyn}oin${prp}!${cyn}$sar(/#/${hcyn}#${cyn}/$3)${hblk}]${hwht}: ${wht}$1${hblk}[${prp}$sar(/@/${cyn}@${prp}/$2) ${hwht}(${wht}$Z${hwht})${hblk}]${cl}
set format_leave $G ${b}${prp}ฎ ${b}${hblk}[${hcyn}p${cyn}art${prp}!${cyn}$sar(/#/${hcyn}#${cyn}/$3)${hblk}]${hwht}: ${wht}$1${hblk}[${prp}$sar(/@/${cyn}@${prp}/$2) ${hwht}(${wht}$Z${hwht})${hblk}]${cl}
fset format_msg $G ${prp}${b}ฎ${b}${hblk}[${hcyn}m${cyn}sg${prp}!${cyn}$1${prp}(${cyn}$sar(/@/${prp}@${cyn}/$2)${prp})${hblk}]${hwht}: ${wht}$3-
...
set format_send_ctcp ${hblk}ฏ [${hcyn}c${cyn}tcp${prp}!${cyn}$1${hblk}]${hwht}: ${wht}$2-
set format_send_dcc_chat ${hblk}ฏ [${hcyn}d${cyn}cc${prp}${prp}(${cyn}$tolower($1)${prp})${hblk}] ${wht}$2-
set format_send_msg $G ${prp}${b}ฏ${b}${hblk}[${hcyn}s${cyn}endmsg${prp}!${cyn}$1${hblk}]${hwht}: ${wht}$3-
set format_names $3
set format_names_banner $3
set -format_names_footer
fset format_send_notice ${hblk}ฏ [${hcyn}n${cyn}otice${prp}!${cyn}$1${hblk}]${hwht}: ${wht}$3-
...
set format_whois_away $G ${CB}${prp}บ${cyn} ${CHH}a${CH}w${hcyn}a${cyn}y${CB}: %n$0 - $1-
set format_whois_channels $G ${CB}${prp}บ${cyn} ${CHH}c${CH}ha${hcyn}nn${cyn}els${CB}: $sar(g/@/${prp}@${wht}/%n$0-)
set format_whois_friend $G ${CB}บ   ${CHH}f${CH}riend${CB}: %nF${CB}:%n$0 $1-
set format_whois_header $G ${CB}${prp}ึอออออออออออออออออออออออออออออออออออ-${hwht}x${cyn}enon${prp}ฤฤ---
set format_whois_help $G ${CB}${prp}บ${cyn}     ${CHH}h${CH}elp${CB}: %n$0 - $1
set format_whois_idle $G ${CB}${prp}บ${cyn} ${CHH}i${CH}${hcyn}d${cyn}le${CB}: %n$0 hours $1 minutes $2 seconds (signon: $stime($3))
set format_whois_name $G ${CB}${prp}บ${cyn} ${CHH}${hcyn}i${CH}${cyn}rcname${CB}: %n$0-
set format_whois_nick $G ${CB}${prp}บ${cyn} ${hcyn}$0 ${prp}(${cyn}$1${prp}@${cyn}$2${prp}) ${hblk}[${wht}%n$3-${hblk}] 
set format_whois_oper $G ${CB}${prp}บ${cyn} ${CHH}o${CH}pe${hcyn}r${cyn}ator${CB}: %n$0 $1-
set format_whois_register $G ${CB}${prp}บ${cyn} ${CHH}r${CH}eg${hcyn}is${cyn}ter${CB}: %n$0 - $1-
set format_whois_server $G ${CB}${prp}บ${cyn} ${CHH}s${CH}er${hcyn}v${cyn}er${CB}: %n$0 ($1-)
set format_whois_service $G ${CB}บ   ${CHH}s${CH}ervice${CB}: %n$0 - $1- 
set format_whois_shit ${CB}บ      ${CHH}s${CH}hit${CB}: %nL:$1 [$1] $2 $3-
set format_whois_signon ${CB}${prp}บ${cyn} ${CHH}s${CH}${hcyn}ignon${CB}: %n$0-
eval set status_cdcccount ${CIH}c${CI}dcc${CB}:${CHH}i${CB}๙${CH}%| ${CHH}o${CB}:${CH}%|${CB}ฤ
eval set status_dcccount ${CIH}d${CI}cc${CB}:${CHH}i${CB}๙${CH}%& ${CHH}o${CB}:${CH}%&${CB}ฤ
eval set status_format1 ${cl}${cyn}฿Ü฿ ${prp}ึ${hblk}[${b}%*%=%@${cyn}%N${cyn}%#${prp})${hblk}]${b}${hmag}๚${cyn}%C${cyn}%+%W%! %>%F %D%J${hblk}[${cyn}%L${prp}$t2()${hblk}]${prp}ฤท
eval set status_format2 ${cl}${cyn}฿ ฿ ${prp}ำ${hblk}[${b}${hwht}x${cyn}enon%T${hblk}]${hmag}๚${prp}%A%Q %>%S${prp}ฝ
...
## eval set status_clock ${prp}ฤ${hblk}[${hcyn}T${prp}!${cyn}%T${hblk}]${prp}-${prp}
